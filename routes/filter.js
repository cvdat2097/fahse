        ...
        function (cb) {
            Product.find({}, function (err, products) {
                ...
                for (i = 0; i < products.length; i++) {
                    if (products[i].category.toString() == req.param('category')) {
        ...
        function (cb) {
            Category.find({}, function (err, categories) {
                ...
                for (i = 0; i < categories.length; i++) {
                    ...
                    if (categories[i]._id.toString() == req.param('category')) { global.listName = categories[i].name };
                }
                cb();
            });
        },
